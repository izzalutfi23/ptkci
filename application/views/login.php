				...
				<div class="login-wrap">
					<div class="login-content">
						<div class="login-logo">
							<a href="#">
								<img src="<?=base_url()?>asset/images/icon/logopekalongan.png" alt="CoolAdmin"
									width="200px">
							</a>
						</div>
						<div class="login-form">
							<form action="<?=base_url('login/auth')?>" method="post">
								...
								<button type="submit" class="au-btn au-btn--block au-btn--green m-b-20 text-center">Login</button>
							</form>
						</div>
					</div>
				</div>
