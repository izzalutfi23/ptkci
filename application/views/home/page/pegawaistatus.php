	...
	<div class="row">
		<div class="col-md-12">
			<div class="overview-wrap">
				<h2 class="title-1"><i class="fas fa-user"></i> Data Pegawai <?=$this->uri->segment(3)?></h2>
			</div><br>
		</div>
	</div>
	<div class="row py-3">
		<div class="col-lg-12">
			<form class="form-header float-right" action="<?=base_url('home/pegawaistatus')?>" method="POST">
